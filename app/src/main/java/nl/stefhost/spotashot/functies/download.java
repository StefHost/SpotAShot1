package nl.stefhost.spotashot.functies;
...
public class download extends AsyncTask<String, String, String> {
	...
	protected String doInBackground(String... input){
		...
		try {
			...
			profielfoto = input[1];
			String link = "http://www.spotashot.nl/uploads/profielfotos/"+tegenstander+"_"+profielfoto+".jpg";
			...
			final File map = new File(opslag,"/Spotashot/profielfotos/");
	...
	protected void onPostExecute(String file_url) {
		File opslag = Environment.getExternalStorageDirectory();
		File plaatje = new File(opslag,"/Spotashot/profielfotos/"+tegenstander+"_"+profielfoto+".jpg");
